          ...
          new Table({
            ...
            rows: [
              ...
              kvRow("Formative Assessment:\nCreate a task, activity or questions to evaluate learning and provide feedback. Provide ways for learners to ask for guidance and support.\nRemember to provide appropriate accommodation so all learners can demonstrate their understanding (e.g. varied response formats, small group options, visual or auditory supports)", hasExitTicket ? [
                ...
                "",
                `<b><i>Item 1 (Terminology / Key Scientist)</i></b>`,
                `${stripTicketLabel(formative.item_1 || "", "item")}`,
                "",
                `<b><i>Item 2 (Location / Structure)</i></b>`,
                `${stripTicketLabel(formative.item_2 || "", "item")}`,
                "",
                `<b><i>Item 3 (Trend / Process / Direction)</i></b>`,
                `${stripTicketLabel(formative.item_3 || "", "item")}`,
                "",
                `<b><i>Item 4 (Underlying Mechanism / Physical Process)</i></b>`,
                `${stripTicketLabel(formative.item_4 || "", "item")}`,
                "",
                `<b><i>Item 5 (Concluding Outcome / System Behavior)</i></b>`,
                `${stripTicketLabel(formative.item_5 || "", "item")}`,
                "",
                `<b><i>Answer Key</i></b>`,
