...
export function planToPlaceholderValues(plan: GeneratedDLPPlan): Record<string, string> {
  ...
  return {
    ...
    FORMATIVE_ITEM_1: formative.item_1 || "",
    FORMATIVE_ITEM_2: formative.item_2 || "",
    FORMATIVE_ITEM_3: formative.item_3 || "",
    FORMATIVE_ITEM_4: formative.item_4 || "",
    FORMATIVE_ITEM_5: formative.item_5 || "",
    FORMATIVE_ANSWER_1: formative.answer_key_1 || "",
    FORMATIVE_ANSWER_2: formative.answer_key_2 || "",
    FORMATIVE_ANSWER_3: formative.answer_key_3 || "",
    FORMATIVE_ANSWER_4: formative.answer_key_4 || "",
    FORMATIVE_ANSWER_5: formative.answer_key_5 || "",
